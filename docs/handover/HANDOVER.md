...
overlap 0，aggregate gate PASS p50 1.018 / p95 1.017，every-scenario diagnostic 在 1K FAIL）都已保存；只剩 RSNA
six-method 結果（calibration v1 與 1M memory gate v2–v4 被 RAM 護欄中止）。
